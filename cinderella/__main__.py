...
PM_START_TEXT = """
_Hello_ *{}*
_My name is_  \n *{}*\n_A Powerful Telegram Group Manager,feel free to add to your groups!!_
_Maintained by_ [Him](t.me/lolboyisback_Bot)
"""


HELP_STRINGS = """
Hey there! My name is *{}*.
_I'm a modular group management bot with a few fun extras! I will take care of your group when you are away._
...
if START_IMG is None:
    img = "https://telegra.ph/file/c6d02a5d4cb81918ace0b.jpg"
else:
  img = "https://telegra.ph/file/c6d02a5d4cb81918ace0b.jpg"
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⛔Help⛔",callback_data="help_back"),InlineKeyboardButton(text="😎Creator😎",url="t.me/lolboyisback_Bot")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="😎Contact Creator😎",url="t.me/lolboyisback")]]))
        return
