...
_Maintained by_ [Him](t.me/lolboyisback)
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⛔Help⛔",callback_data="help_back"),InlineKeyboardButton(text="😎Creator😎",url="t.me/lolboyisback")]]
